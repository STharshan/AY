...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Took my VW Golf down to AY Detailing today - first time using these guys and they did not disappoint! My car went in for a full interior detail which I am very happy with. Most importantly the car feels brand new which is amazing. The service from these guys was also on point. Amazing job would definitely recommend - will be back 100%.",
    name: "lby",
  },
